...
ALLOWED_HOSTS = [
    'localhost',
    'ashrafm1230-8000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai',
]

CSRF_TRUSTED_ORIGINS = [
    'https://ashrafm1230-8000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai'
]
